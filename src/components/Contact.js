    ...
    return (
        <div>
            <div className='flex flex-row justify-center items-center gap-3 mt-3'>
                <button className=' px-4 py-2 text-white rounded-lg font-bold shadow-md transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-blue-700 duration-300'>Download CV</button>
